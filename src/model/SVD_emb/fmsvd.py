...
class FMSVD(pl.LightningModule):
    ...
    def forward(self, x, x_cont, emb_x, svd_emb):
        ...
        lin_term = self.linear.forward(x=x, emb_x=svd_emb, x_cont=x_cont)
        inter_term = self.interaction.forward(x_cont=x_cont, emb_x=emb_x, svd_emb=svd_emb)
    ...
    def training_step(self, batch, batch_idx):
        ...
        y_pred = self.forward(x=x, x_cont=x_cont, emb_x=embed_x, svd_emb=svd_emb)
